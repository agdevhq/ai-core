...
export function parseOpenAIEmbedProviderOptions(
    ...
    return parseOpenAIProviderOptions(providerOptions, openaiEmbedProviderOptionsSchema);
}
...
export function parseOpenAIImageProviderOptions(
    ...
    return parseOpenAIProviderOptions(providerOptions, openaiImageProviderOptionsSchema);
}
