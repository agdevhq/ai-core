...
<CardGroup cols={2}>
  ...
  >
    Cancelling a stream with `AbortController`. Shows how to abort an in-progress stream and handle `StreamAbortedError`.
  </Card>
</CardGroup>
...
- **13-stream-abort.ts** - Cancel streams with AbortController
