...
<CardGroup cols={2}>
  ...
  >
    Aborting a stream with `AbortSignal` and handling `StreamAbortedError`. Shows how to cancel in-progress streams gracefully.
  </Card>
</CardGroup>
...
- **13-stream-abort.ts** - Cancel streams with AbortSignal
