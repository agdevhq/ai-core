...
<Tabs>
  <Tab title="OpenAI">
    ...
    <Note>
      The OpenAI adapter supports chat completion, streaming, tool calling, structured outputs, embeddings, and image generation.
    </Note>
  </Tab>
  ...
  <Tab title="Anthropic">
    ...
    <Note>
      The Anthropic adapter supports chat completion, streaming, tool calling, structured outputs, vision, and extended thinking with Claude models.
    </Note>
  </Tab>
  ...
  <Tab title="Mistral">
    ...
    <Note>
      The Mistral adapter supports chat completion, streaming, tool calling, and embeddings.
    </Note>
  </Tab>
</Tabs>
