...
Use model IDs enabled for your organization in Omnifact. Pass `providerOptions.openai` for Chat Completions-specific options (same API surface as `@core-ai/openai/compat`).
