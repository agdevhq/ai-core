---
title: 'Utilities'
description: 'Helper functions for schemas, messages, streams, and provider metadata'
icon: 'toolbox'
---

## Overview

core-ai exports helpers for schema conversion, assistant message construction, stream creation, and provider-specific metadata access.
