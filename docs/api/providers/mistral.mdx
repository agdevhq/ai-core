...
| Vision | Limited |
| Reasoning | Yes (native) |
| Embeddings | Yes |
| Image Generation | No |

<Note>
  Mistral models handle reasoning natively without explicit effort control parameters. Models that support thinking (such as Magistral) automatically include reasoning content in responses.
</Note>
