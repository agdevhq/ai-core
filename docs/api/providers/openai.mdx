...
<AccordionGroup>
  ...
  <Accordion title="Other models" icon="circle">
    Any model ID not listed above is accepted and uses default capabilities. Pass any valid OpenAI model identifier to `chatModel()`.
  </Accordion>
</AccordionGroup>
